...
router.get('/:id/edit', (req, res) => {
    db.Beauty.findById(req.params.id)
        ...
        .then(beauty => res.render('beauties/edit-form', { beauty: beauty }))
})


// 2.3.4 Update Route (PUT/Update): This route receives the PUT request sent from the edit route, 
// 2.3.4 edits the specified beauty document using the form data,
...
// 2.3.5 Destroy Route (DELETE/Delete): This route deletes a beauty document 
// 2.3.5 using the URL parameter (which will always be the beauty document's ID)
